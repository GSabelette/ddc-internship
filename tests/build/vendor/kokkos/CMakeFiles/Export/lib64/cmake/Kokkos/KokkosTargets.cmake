...
foreach(_expectedTarget Kokkos::CUDA Kokkos::kokkoscore Kokkos::kokkoscontainers Kokkos::kokkosalgorithms Kokkos::kokkos)
...
set_target_properties(Kokkos::kokkoscore PROPERTIES
  ...
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CXX>:-march=skylake-avx512;-mtune=skylake-avx512;-mrtm>;\$<\$<COMPILE_LANGUAGE:CXX>:-expt-extended-lambda;-Wext-lambda-captures-this;-lineinfo;-arch=sm_70>;\$<\$<COMPILE_LANGUAGE:CXX>:>;\$<\$<COMPILE_LANGUAGE:CXX>:-Xcompiler;-fopenmp>"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/kokkos"
  INTERFACE_LINK_LIBRARIES "Kokkos::CUDA;Kokkos::LIBDL"
  INTERFACE_LINK_OPTIONS "\$<\$<LINK_LANGUAGE:CXX>:-DKOKKOS_DEPENDENCE;-fopenmp;-march=skylake-avx512;-mtune=skylake-avx512;-mrtm;-arch=sm_70>"
)
